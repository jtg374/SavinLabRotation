...
k_cue0 = 10 # for initial cue distribution
v_noise = 0 # for cue noise accumulation, k_cue(t) = 1/( 1/k_cue0 + v_noise*t/T_theta )
...
sol = solver_RK4(lambda t,y: mainode(t,y,**kwargs),(tNow,tf),xNow,t_step=dt)
t   = sol.t; tNow = sol.t[-1]
x_t = sol.y; xNow = sol.y[:,-1]
# t_fire = sol.t_events
